...
const Add = ({setClose}) => {
    ...
    // tutorial how to handle multiple input in React
    const handleExtraInput = (e) => {
        setExtra({...extra, [e.target.name]: e.target.value});
    };

      // tutorial: How to set state using prev data
    const handleExtra = (e) => {
       ...
       <h1>Add a new Pizza</h1>
        ...
        <div className={styles.item}>
            ...
            <div className={styles.item}>
                ...
                <input 
                    className={`${styles.input} ${styles.inputSm}`} 
                    type="number" placeholder="Medium" 
